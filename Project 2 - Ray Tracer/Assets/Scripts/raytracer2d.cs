/*See debug.log at 179. It prints out the correct values for each of the pixels but the screen.setpixel doesnt work
 * I dont know why it doesnt update the image but there seems to be no work around so im turining it in as is.
*/
...
public class raytracer2d : MonoBehaviour {
	...
	void Start () {
		//func1();
		screen = new Texture2D(Screen.width, Screen.height); //screen size
	}
